        ...
        >
          ...
          <div className="glass p-8 md:p-12 rounded-3xl text-left">
            <p className="text-slate-600 dark:text-gray-300 text-lg leading-relaxed mb-6">
              Hello! I&apos;m <strong className="text-slate-900 dark:text-white">Sachin Sharma</strong>, a passionate DevOps enthusiast 
            ...
            <div className="flex justify-center flex-wrap gap-4">
              <a 
                ...
                className="flex items-center gap-3 px-8 py-4 bg-slate-100 dark:bg-white/10 text-slate-900 dark:text-white font-bold rounded-full hover:bg-neon-blue hover:text-black hover:shadow-[0_0_15px_rgba(0,240,255,0.6)] transition-all group border border-slate-200 dark:border-white/10"
              >
